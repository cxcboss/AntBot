...
contextBridge.exposeInMainWorld('antbot', {
  ...
  publishBridgeOpenBrowser: (platform) => ipcRenderer.invoke('publish:bridge-open-browser', platform),
  ...
  monitorAdd: (data) => ipcRenderer.invoke('monitor:add', data),
  monitorUpdate: (id, patch) => ipcRenderer.invoke('monitor:update', { id, patch }),
  monitorRemove: (id) => ipcRenderer.invoke('monitor:remove', id),
  monitorCheckNow: (id) => ipcRenderer.invoke('monitor:check-now', id),
  monitorToggle: (id, enabled) => ipcRenderer.invoke('monitor:toggle', { id, enabled }),
  onMonitorUpdate: (callback) => on('monitor:updated', callback),
});
