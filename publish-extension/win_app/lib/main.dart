...
const _bundledFiles = <String>[
  ...
  'assets/local-server/bridgeQueue.js',
...
class _HomePageState extends State<HomePage> with WindowListener {
  ...
  Future<void> _initApp() async {
    await windowManager.setTitle('搬运蚁发布助手');
    final appSupport = await getApplicationSupportDirectory();
    _appDir = p.join(appSupport.path, '搬运蚁发布助手');
  ...
  Future<void> _initTray() async {
    ...
    await _tray!.initSystemTray(title: '搬运蚁发布助手', iconPath: iconPath);
    ...
    await _tray!.setToolTip('搬运蚁发布助手');
            ...
            child: ListView(
              children: [
                Row(children: [
                  ...
                  const Text('搬运蚁发布助手', style: TextStyle(fontSize: 17, fontWeight: FontWeight.w600)),
                  const Spacer(),
